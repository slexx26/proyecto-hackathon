...
const paths: Record<IconName, string> = {
  ...
  wheelchair:
    'M14.2 15a5 5 0 1 1-10 0 5 5 0 0 1 10 0ZM10.2 15a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM7 4.5 9 4.5 9.5 9 14.2 9.3 14.2 12.5 17.4 15.6M18.7 16.9a1.3 1.3 0 1 1-2.6 0 1.3 1.3 0 0 1 2.6 0Z',
